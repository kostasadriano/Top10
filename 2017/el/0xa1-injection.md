...
| Φορείς απειλής/Τρόποι επίθεσης | Ευπάθεια           | Αντίκτυπος               |
| -- | -- | -- |
...
## Είναι η Εφαρμογή ευάλωτη;

Μια εφαρμογή είναι ευάλωτη σε επίθεση όταν:
...
## Πως να το αποτρέψετε

Για την αποτροπή της έγχυσης (injection) απαιτείται ο διαχωρισμός των δεδομένων από τις εντολές και τα ερωτήματα (queries)
...
**Σενάριο #1**: An application uses untrusted data in the construction of the following vulnerable SQL call:

`String query = "SELECT * FROM accounts WHERE custID='" + request.getParameter("id") + "'";`

**Σενάριο #2**: Similarly, an application’s blind trust in frameworks may result in queries that are still vulnerable, (e.g. Hibernate Query Language (HQL)):
